...
@section('content')
<div class="container-fluid patient-create">
    <div>
        <a href="{{url("patient")}}" type="button" class="btn font-weight-bold btn-pattern">Listar</a>
    </div>
    ...
    <form method="post" action="{{url("patient/store")}}">
        @method('POST')
        @csrf
        <div class="row">
