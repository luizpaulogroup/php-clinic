...
<div class="container-fluid user-details">
    <div>
        <a href="{{url("user")}}" type="button" class="btn font-weight-bold btn-pattern">Voltar</a>
    </div>
    ...
    <form method="post" action="{{url("user/update/$user->id")}}">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <input autocomplete="off" type="text" name="name" class="form-control" value="{{$user->name}}" required minlength="3">
            </div>
            <div class="form-group col-md-12">
                <label class="font-weight-bold text-uppercase">E-mail</label>
                <input autocomplete="off" type="text" name="email" class="form-control" value="{{$user->email}}" required>
            </div>
            <div class="form-group col-md-6">
                <label class="font-weight-bold text-uppercase">Última alteração</label>
                <input disabled type="text" name="created_at" class="form-control" value="{{$user->created_at}}">
            </div>
            <div class="form-group col-md-6">
                <label class="font-weight-bold text-uppercase">Data de cadastro</label>
                <input disabled type="text" name="updated_at" class="form-control" value="{{$user->updated_at}}">
            </div>
            <div class="form-group col-md-12">
